    ...
    <div class="row mt-5">
        <div class="col-2">
            <div class="list-group" id="list-tab" role="tablist">
                ...
                <a class="list-group-item list-group-item-action" id="list-directory-list" data-bs-toggle="list" href="/directory" role="tab" aria-controls="list-directory">Palmet Grup Rehberi</a>
                <a class="list-group-item list-group-item-action" id="list-gallery-list" data-bs-toggle="list" href="/gallery" role="tab" aria-controls="list-gallery">Palmet Galeri</a>
            </div>
        </div>
