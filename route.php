...
$routes = [
    ...
    'org_reg_pro' => 'pages/organization_register_process.php',   // Organizasyon kayıt işlemi
    'org_edit' => 'pages/org_edit.php',         // Organizasyon düzenleme sayfası
    'org_process' => 'pages/org_dashboard.php',   // Organizasyon işlemleri sayfası
    'blog_list' => 'pages/blog_list.php', // Yazı listesi sayfası
    'course' => 'pages/course.php',
    'blog' => 'pages/blog.php',
    'add_blog' => 'pages/add_blog.php',         // Yazı ekleme sayfası
    'blog_view' => 'pages/blog_view.php', // Yazı detay sayfası
